...
export const EnterPassword = (): JSX.Element => {
  ...
  return (
    <ScaleWrapper width={1440} height={1024} anchor="bottom" fillViewportHeight>
      <main
        className="relative flex h-[1024px] w-[1440px] flex-col items-start gap-2.5 overflow-hidden bg-white"
